...
const EXTRA_AUDIO_ASSETS: AudioAsset[] = [
  ...
  { id: 'amb-lab-deck', name: 'Deck 02 Lab Ambience', kind: 'sound', group: 'Interior SFX', status: 'missing', use: 'game', duration: 'loop', prompt: 'Derelict orbital lab ambience: glass stress ticks, cold filtered ventilation, faint specimen tank bubbles, electrical microscopy hum, loopable, no music.' },
  { id: 'amb-cargo-deck', name: 'Deck 00 Cargo Ambience', kind: 'sound', group: 'Interior SFX', status: 'missing', use: 'game', duration: 'loop', prompt: 'Lower cargo and reactor deck ambience: low coolant pumps, distant chain sway, reactor throb, pipes knocking like footsteps, loopable, no music.' },
  ...
  { id: 'sfx-lift-start', name: 'Deck Lift Start', kind: 'sound', group: 'Interior SFX', status: 'missing', use: 'game', duration: '0:02', prompt: 'Small industrial spacecraft deck lift starting: magnetic brake release, servo whine, metal platform vibration, close and heavy.' },
  { id: 'sfx-lift-stop', name: 'Deck Lift Stop', kind: 'sound', group: 'Interior SFX', status: 'missing', use: 'game', duration: '0:01', prompt: 'Spacecraft deck lift arriving: servo whine drops, magnetic clamp thunk, short hydraulic sigh.' },
  ...
  { id: 'sfx-deck-alarm', name: 'Deck Alarm Chirp', kind: 'sound', group: 'Interior SFX', status: 'missing', use: 'game', duration: '0:03', prompt: 'Short derelict deck alarm burst: three panicked warning chirps, relay chatter, then an abrupt cut to silence.' },
  { id: 'sfx-specimen-scan', name: 'Specimen Scan', kind: 'sound', group: 'Interior SFX', status: 'missing', use: 'game', duration: '0:03', prompt: 'Bio-lab specimen scanner: glassy medical beeps, soft laser sweep, wet tank resonance underneath.' },
  { id: 'sfx-reactor-nest', name: 'Reactor Nest Sample', kind: 'sound', group: 'Interior SFX', status: 'missing', use: 'game', duration: '0:03', prompt: 'Sampling an organic nest beside a reactor: sticky probe click, wet chitin scrape, low pipe vibration.' },
  ...
  { id: 'sfx-skitter', name: 'Swarmer Floor Skitter', kind: 'sound', group: 'Creature SFX', status: 'missing', use: 'game', duration: '0:03', prompt: 'Small many-legged creature skittering under metal deck plates, close left-to-right movement, frantic wet claws.' },
  { id: 'sfx-warden', name: 'Warden Echo Beat', kind: 'sound', group: 'Creature SFX', status: 'missing', use: 'game', duration: '0:04', prompt: 'Floating lab warden echo: distant hollow throat tone, reversed breath, soft human syllable stretched into a warning.' },
  ...
  { id: 'vox-vesta-lift', name: 'VESTA Lift Transfer', kind: 'voice', group: 'Spoken Text', status: 'missing', use: 'game', duration: 'line', voice: 'VESTA', prompt: '[calm, close intercom] Deck transfer engaged. [pause] Please remain inside the marked lift volume. [quieter] Motion detected between decks.' },
  { id: 'vox-vesta-lab', name: 'VESTA Lab Deck', kind: 'voice', group: 'Spoken Text', status: 'missing', use: 'game', duration: 'line', voice: 'VESTA', prompt: '[clinical] Deck two laboratory telemetry is awake. [pause] No living science crew are registered aboard.' },
  { id: 'vox-vesta-cargo', name: 'VESTA Cargo Deck', kind: 'voice', group: 'Spoken Text', status: 'missing', use: 'game', duration: 'line', voice: 'VESTA', prompt: '[calm but lower] Deck zero cargo and reactor loop. [pause] Coolant temperature suggests recent movement.' },
